...
\begin{dialogue}{Miguel}
    Não preciso. \paren{apontando para a própria cabeça} Eu sou bom da cabeça, Jupará.
\end{dialogue}
...
\begin{dialogue}[olha para Jupará]{Miguel}
...
\begin{dialogue}[em tom de reprovação]{Miguel}
...
\begin{dialogue}[interropendo JUPARÁ]{Miguel}
...
\begin{dialogue}{Jupará}
    ...
    \paren{Uma pilastra fica entre Miguel e Jupará} Que porra de pilastra.
